1. waht is lo interface in linux ?
         ...
         lo stands for loopback.It is a virtual network interface that allows a Linux machine to communicate with itself.
...
2. What is eth0 ?
         ...
         eth0 is the network connection that Linux uses to communicate with other machines.
